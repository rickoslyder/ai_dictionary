...
function handleKeyboardShortcut(event) {
    ...
    if (event.key.toUpperCase() === keyboardShortcut.key.toUpperCase() &&
...
function createSelectionButton(event, text) {
    ...
    console.log("Selection button added to document.body at:", selectionButton.style.left, selectionButton.style.top);
...
function createTooltip(text) {
    ...
    if (selection && selection.rangeCount > 0) {
        ...
        console.log("Positioned tooltip at:", tooltip.style.left, tooltip.style.top);
        ...
        setTimeout(() => {
            ...
            console.log("Adjusted tooltip position to:", tooltip.style.left, tooltip.style.top);
        }, 0);
    }
    else {
